  ...
  <section class="text-gray-600 body-font relative">
    <div class="container px-5 py-10 mx-auto">
      <div class="flex flex-col text-center w-full mb-6">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Formulário de Auxílio Transporte</h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">do município de
      ...
      <button :url="'https://www.google.com.br/?hl=pt-BR'">
        Link do Formulário
      </button>
      ...
      <div class="text-gray-600 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-col">
          <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            ...
            <a href="https://github.com/danielbelle" class="text-gray-600 ml-1" rel="noopener noreferrer"
              target="_blank">
